...
<head>
    ...
    <title>Способы оплаты - Куллаты</title>
        ...
        <table>
            <tr class="text-justify">
                <td class="px-2">
                    ...
                    <p>Отправляете через Мобильный банк Сбербанк на телефонный номер: <strong>89142753653</strong></p>
                </td>
            </tr>
            <tr class="text-justify">
                <td class="px-2">
                    <hr>
                    <p>
                        Мы всегда будем рады видеть Вас по адресу: <strong>📍ул.Комсомольская 14/1, здание «АвтоДом».</strong>
                        <br>
                        <br>
                        Прайс услуг в обычные дни:
                        <ul>
                            <li>
                                🚀 доставка на дом (обмен)-100₽
                            </li>
                            <li>
                                🚗 самовывоз (разлив)-50₽
                            </li>
                            <li>
                                💧доставка+новая тара с чистой водой 500₽
                            </li>
                        </ul>
                    </p>
                </td>
